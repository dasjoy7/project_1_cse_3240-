            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  _statChip(
                    "Accepted",
                    user['accepted']?.toString() ?? '0',
                    Colors.green,
                  ),
                  _statChip(
                    "Wrong",
                    user['wrong']?.toString() ?? '0',
                    Colors.red,
                  ),
                ],
              ),
              ...
              Row(
                ...
                children: [
                  _statChip(
                    "Easy",
                    user['easy_solve']?.toString() ?? '0',
                    Colors.green.shade300,
                  ),
                  _statChip(
                    "Medium",
                    user['medium_solve']?.toString() ?? '0',
                    Colors.orange,
                  ),
                  _statChip(
                    "Hard",
                    user['hard_solve']?.toString() ?? '0',
                    Colors.red.shade700,
                  ),
                ],
              ),
              ...
              _infoRow(
                ...
                "Total Submissions",
                user['total_submissions']?.toString() ?? '0',
              ),
        ...
        builder: (context, setDialogState) => AlertDialog(
          ...
          content: RichText(
            text: TextSpan(
              ...
              children: [
                const TextSpan(
                  text: "You are about to permanently delete the account of ",
                ),
                TextSpan(
                  text: "@${user['username']}",
                  ...
                  : () async {
                      ...
                      try {
                        ...
                        if (context.mounted) {
                          Navigator.pop(context);
                          _showSnackBar(
                            'Account @${user['username']} has been terminated.',
                          );
                          await _fetchUsers();
                        }
                      } catch (e) {
